...
#     pri[j] = []
#     for i in range(4):
#         pri[j].append(list(map(int, input().split())))
#
# #상어의 위치를 찾는 함수
...
#
# #상어의 다음 향할 곳을 찾는 함수
# def find_d(now_dir, now_x, now_y,shark_num):
#     now_dir = dir
#     shark_num -= 1
#     for i in range(4):
#         added = pri[shark_num][i]
#         nx = now_x + dx[added]
#         ny = now_y + dy[added]
#
...
#각 위치마다 [특정 내새의 상어 번호, 특정 냄새의 남은 시간]을 저장하는 2차원 리스트
